                            ...
                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionFilters">
                                <div class="card-body">
                                    <form method="GET" action="{{ route('reportes-maquinados.index') }}">
                                        ...
                                        <div class="form-row mb-2">
                                            <div class="col-md-4">
                                                <input type="number" name="id_area" class="form-control" placeholder="ID Área" value="{{ $id_area }}">
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <td>
                                                    @can('acceder-admin-ventas')
                                                        <form action="{{ route('reportes-maquinados.destroy', $reportesMaquinado->id) }}" method="POST">
                                                            <a class="btn btn-sm btn-primary" href="{{ route('reportes-maquinados.show', $reportesMaquinado->id) }}">
                                                                <i class="fa fa-fw fa-eye"></i> {{ __('Show') }}
                                                            </a>
                                                            <a class="btn btn-sm btn-success" href="{{ route('reportes-maquinados.edit', $reportesMaquinado->id) }}">
