<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="estatus" class="form-control @error('estatus') is-invalid @enderror" value="{{ old('estatus', $maquina?->estatus) }}" id="estatus" placeholder="Estatus">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_area" class="form-control @error('id_area') is-invalid @enderror" value="{{ old('id_area', $maquina?->id_area) }}" id="id_area" placeholder="Id Area">
